...
void Hardware::outputLvl(void) {
	//Throut the ports to output.
	pinMode(get_pin_xbeeSelect(), OUTPUT);
}
...
uint8_t Hardware::get_pin_xbeeSelect() {
	return pin_xbeeSelect;
}

void Hardware::set_xbeeSelect(void) {
	digitalWrite(get_pin_xbeeSelect(), HIGH);
}
